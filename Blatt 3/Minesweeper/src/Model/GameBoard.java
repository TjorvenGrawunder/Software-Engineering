...
public class GameBoard extends Observable {
    ...
    *
    * @param width         number of {@code Field} elements in each row
    * @param height        number of rows
    * @param numberOfBombs number of bombs to be placed randomly in this game
    * @throws IllegalArgumentException if {@code width} is < 1
    * @throws IllegalArgumentException if {@code height} is < 1
    * @throws IllegalArgumentException if {@code numberOfBombs} is >
    * width*height-1
    */
    ...
    *
    * @param f {@code Field} that has been revealed
    */
    ...
    *
    * @param f {@code Field} which flag has changed.
    */
    ...
    *
    * @param xPos x-axis value of the requested {@code Field}
    * @param yPos y-axis value of the requested {@code Field}
   ...
   public class Field extends Observable {
       ...
       *
       * @param bomb if the {@code Field} should contain a bomb or not
       */
       ...
       * neighboring bombs.
       *
       * @param xPos x-axis value of the position of this {@code Field}
       * @param yPos y-axis value of the position of this {@code Field}
       */
       ...
       *
       * @param xPos x-axis value of the {@code Field} which neighbors should be
       *             collected
       * @param yPos y-axis value of the {@code Field} which neighbors should be
       *             collected
