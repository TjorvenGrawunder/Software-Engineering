...
public class MineSweeper implements Runnable {
    ...
    *
    * @param args height of the game in args[0], width of the game in args[1] and
   ...
   public static void main(String[] args) {
      ...
      MineSweeper mineSweeper = new MineSweeper(width, height, bombs);
   ...
   public void run() {
      ...
      GameView view = new GameView(model, new GameView.GameOverListener() {
         @Override
